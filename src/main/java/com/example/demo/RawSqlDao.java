...
///// LEVEl 3 ///////	
	...
	public void insertPayment(Payment payment) {
		String sql = "INSERT INTO SF_SHOP_PAYMENT ( HEAD_ID, SHOP_BR_ID, MNT_AMT, DAY_GAP, INT_AMT, INI_DATE, LAST_PAY, NEXT_PAY, PAY_MON )VALUES( "+payment.HEAD_ID+", "+payment.SHOP_BR_ID+", "+payment.MNT_AMT+", "+payment.DAY_GAP+"," +payment.INT_AMT+", TO_DATE('"+payment.INI_DATE+"', 'YYYY-MM-DD'), TO_DATE('"+payment.LAST_PAY+"', 'YYYY-MM-DD'), TO_DATE('"+payment.NEXT_PAY+"', 'YYYY-MM-DD'), '"+payment.PAY_MON+"')";
	...
	public void insertPayment1(Payment payment) {
		String sql = "INSERT INTO SF_SHOP_PAYMENT_HIST ( HEAD_ID, SHOP_BR_ID, MNT_AMT, TRAN_DATE, TRAN_MON, PAY_MODE,TRAN_ID,  AUTH )VALUES( "+payment.HEAD_ID+", "+payment.SHOP_BR_ID+", "+payment.MNT_AMT+", SYSDATE, '"+payment.PAY_MON+"', 'Cash','0', 'Y')";
		BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(payment);
		NamedParameterJdbcTemplate template = new NamedParameterJdbcTemplate(jdbcTemplate);
		template.update(sql, param);
	}
