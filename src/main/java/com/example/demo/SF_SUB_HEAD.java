...
public class SF_SUB_HEAD {
	...
	public SF_SUB_HEAD(int sUB_HEAD_ID, int pARENT_ID, String hEAD_NAME, int lEV, String cHILD_NAME) {
		super();
	...
	public SF_SUB_HEAD(int sUB_HEAD_ID, int pARENT_ID, String cHILD_NAME) {
		super();
		SUB_HEAD_ID = sUB_HEAD_ID;
		PARENT_ID = pARENT_ID;
		CHILD_NAME = cHILD_NAME;
